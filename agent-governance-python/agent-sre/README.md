...
Agent SRE directly addresses **[OWASP Agentic Security Initiative](../../docs/compliance/owasp-asi-policy-mapping.md)** risk **ASI08 — Cascading Agent Failures**:
...
> See full [OWASP Agentic Top 10 mapping →](../../docs/compliance/owasp-asi-policy-mapping.md)
