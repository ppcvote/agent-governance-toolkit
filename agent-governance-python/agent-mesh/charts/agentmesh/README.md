...
| `trustEngine.image.repository`     | Image repository       | `ghcr.io/microsoft/agent-governance-toolkit/trust-engine`   |
...
| `policyServer.image.repository`     | Image repository            | `ghcr.io/microsoft/agent-governance-toolkit/policy-server`  |
...
| `auditCollector.image.repository`      | Image repository        | `ghcr.io/microsoft/agent-governance-toolkit/audit-collector`    |
...
| `apiGateway.image.repository`      | Image repository        | `ghcr.io/microsoft/agent-governance-toolkit/api-gateway`    |
